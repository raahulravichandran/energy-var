...
ax[0].text(0.5,-40,"14 of 36 rolls exceed ±10%\nspurious splices, not market moves",
...
y=np.arange(len(ks))
ax.axvline(1.0,color=INK,lw=1.5,ls="--"); ax.text(1.02,3.56,"√t holds (VR=1)",fontsize=9,color=INK)
